...
public class AdminUserSeeder implements DataSeeder {
    ...
    private void initUser() {
        generateUser(DEFAULT_USER_ID, "developer", "Developer", "developer", adminRoleSeeder.getRoles().get(AdminConstant.ROLE_DEVELOPER), CommonConstant.STATUS_ACTIVE, "https://res.cloudinary.com/dsao23xch/image/upload/v1770585338/gemini-generated-pic-2.png");
    ...
    private void generateUser(Long id, String username, String fullName, String password, AdminRole adminRole, int status, String profilePicture) {
