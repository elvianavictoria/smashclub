...
public class AdminEquipmentCategoryController {
    ...
    @GetMapping
    public ResponseEntity<Object> equipmentCategoryList(@RequestParam String keyword, @RequestParam(required = false) Integer status, @RequestParam int page, @RequestParam int size, HttpServletRequest request) {
        Pageable pageable = PageRequest.of(page, size);
        return adminEquipmentCategoryService.findAll(keyword, status, pageable, request);
    }
