...
public class AdminProductController {
    ...
    @GetMapping
    public ResponseEntity<Object> productList(@RequestParam String keyword, @RequestParam(required = false) Integer status, @RequestParam int page, @RequestParam int size, HttpServletRequest request) {
        Pageable pageable = PageRequest.of(page, size);
        return adminProductService.findAll(keyword, status, pageable, request);
    }
